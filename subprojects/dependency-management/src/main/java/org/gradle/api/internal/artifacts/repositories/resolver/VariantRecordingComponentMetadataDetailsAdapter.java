...
public class VariantRecordingComponentMetadataDetailsAdapter implements ComponentMetadataDetails {
    ...
    private final Set<String> seenVariants;
    private boolean allVariantsUsed;

    public VariantRecordingComponentMetadataDetailsAdapter(MutableModuleComponentResolveMetadata metadata, Instantiator instantiator,
        ...
        this.seenVariants = new HashSet<String>();
    }
    ...
    public Set<String> getSeenVariants() {
        return seenVariants;
    }

    public boolean isAllVariantsUsed() {
        return allVariantsUsed;
    }

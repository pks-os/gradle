...
abstract class AbstractRealisedModuleComponentResolveMetadata extends AbstractModuleComponentResolveMetadata {

    protected static final String ALL_VARIANTS_NAME = "__ALL||VARIANTS++";

    static ImmutableList<? extends ComponentVariant> enrichVariants(DefaultMutableIvyModuleResolveMetadata mutableMetadata, Set<String> remainingVariants) {
        ImmutableList<? extends ComponentVariant> variants = mutableMetadata.getVariants();
        ...
        for (ComponentVariant variant : variants) {
            ...
            ImmutableAttributes attributes = mutableMetadata.getVariantMetadataRules().applyVariantAttributeRules(variant, variant.getAttributes());
    ...
    public AbstractRealisedModuleComponentResolveMetadata(AbstractMutableModuleComponentResolveMetadata mutableMetadata, ImmutableList<? extends ComponentVariant> variants, Map<String, ImmutableAttributes> potentialVariantToAttributesMap, ImmutableAttributes allVariantsAttributes) {
